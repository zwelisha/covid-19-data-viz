...
app.layout = html.Div(
    children = [
        html.H1("COVID-19 Data Analysis and Visualisation", style={'color': 'white', 'backgroundColor': 'maroon', 'padding': '15px'}),
...
def update_graph(selected_data):
    ...
    layout = graph_obj.Layout(
        title='COVID-19 Data Visualisation for the variable selected above',
